...
struct Volume: View {
    ...
    .padding(.all)
                                Button(action: {
                                    ...
                                    Text(self.DisplayUnit1 + "  "  + env.displayconvertvolume)
                                    }
                                .sheet(isPresented: $ShowUnit1) {
                                    ModalVolume(isPresented: self.$ShowUnit1, isPresented1: self.$ShowUnit1, isPresented2: self.$ShowUnit2, currentUnit1: self.$DisplayUnit1, currentUnit2: self.$DisplayUnit2)
                                }
                                    .font(.system(size: 40))
