//
//  CalculatorButtonViewScientific.swift
//  Ultimate_Calculator
//
...
struct CalculatorButtonViewScientific: View {
    ...
    var body: some View {
        Button(action: {
            ...
            Text(button.title)
            .font(.system(size: 30))
                .frame(width: self.buttonWidth1(button: button), height: ((UIScreen.main.bounds.width - 11 * 6) / 10) * 0.55)
    ...
    private func buttonWidth1(button: CalculatorButton) -> CGFloat {
        return ((UIScreen.main.bounds.width - 11 * 6) / 10) * 0.9
    }
}
//struct CalculatorButtonViewScientific_Previews: PreviewProvider {
//    static var previews: some View {
//        CalculatorButtonViewScientific()
//    }
//}
