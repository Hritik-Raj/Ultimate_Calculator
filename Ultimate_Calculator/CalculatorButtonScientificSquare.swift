//
//  CalculatorButtonScientificSquare.swift
//  Ultimate_Calculator
//
...
struct CalculatorButtonScientificSquare: View {
    ...
    var body: some View {
        Button(action: {
            ...
            Text(button.title)
            .font(.system(size: 30))
                .frame(width: self.buttonWidth2(button: button), height: ((UIScreen.main.bounds.width - 11 * 6) / 10) * 0.55)
                .foregroundColor(.white)
                .background(self.buttoncolor(viewRouter: viewRouter, button: button))
//                .cornerRadius(self.buttonWidth1(button: button))
        }
    }
    ...
    private func buttonWidth2(button: CalculatorButton) -> CGFloat {
        return ((UIScreen.main.bounds.width - 11 * 6) / 10) * 0.9
    }
}
//struct CalculatorButtonScientificSquare_Previews: PreviewProvider {
//    static var previews: some View {
//        CalculatorButtonScientificSquare()
//    }
//}
